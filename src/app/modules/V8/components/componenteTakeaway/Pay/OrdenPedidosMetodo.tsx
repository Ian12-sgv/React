      ...
      <div className="takeaway-ContenidoOrder-Orden">
        ...
        <div className="orden-bottom-info">
          <div className="bottom-top-info-orden">
            ...
            <div className="total-OrdennPedidosMetodo">Total</div>
          </div>
          <div className="bottom-top-info-orden">
            ...
            <div className="total-OrdenPedidosMetodo">$46.00</div>
          </div>
        </div>
      </div>
...
export default OrdenPedidosMetodo;
