        ...
        <div className="row">
          ...
          <div className="col-lg-6 mb-3">
            ...
            <div className="menu-item p-0 m-0">
              {/* begin:Menu link */}
              <a
                onClick={() => setLayoutType("light-sidebar")}
                className="menu-link"
              >
            ...
            <div className="menu-item p-0 m-0">
              {/* begin:Menu link */}
              <a
                onClick={() => setLayoutType("dark-sidebar")}
                className="menu-link"
              >
                <span className="menu-bullet">
                  <span className="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
            ...
            <div className="menu-item p-0 m-0">
              {/* begin:Menu link */}
              <a
                onClick={() => setLayoutType("light-header")}
                className="menu-link"
              >
                <span className="menu-bullet">
                  <span className="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
            ...
            <div className="menu-item p-0 m-0">
              {/* begin:Menu link */}
              <a
                onClick={() => setLayoutType("dark-header")}
                className="menu-link"
              >
                <span className="menu-bullet">
                  <span className="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
          ...
          <div className="col-lg-6 mb-3">
            ...
            <div className="menu-item p-0 m-0">
              {/* begin:Menu link */}
              <a
                onClick={() => setToolbarType("classic")}
                className="menu-link"
              >
                <span className="menu-bullet">
                  <span className="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
            ...
            <div className="menu-item p-0 m-0">
              {/* begin:Menu link */}
              <a
                onClick={() => setToolbarType("accounting")}
                className="menu-link"
              >
                <span className="menu-bullet">
                  <span className="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
            ...
            <div className="menu-item p-0 m-0">
              {/* begin:Menu link */}
              <a
                onClick={() => setToolbarType("extended")}
                className="menu-link"
              >
                <span className="menu-bullet">
                  <span className="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
            ...
            <div className="menu-item p-0 m-0">
              {/* begin:Menu link */}
              <a
                onClick={() => setToolbarType("reports")}
                className="menu-link"
              >
                <span className="menu-bullet">
                  <span className="bullet bullet-dot bg-gray-300i h-6px w-6px"></span>
